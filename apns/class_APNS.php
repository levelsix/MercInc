...
class APNS {
	...
	* @access private
	*/
	private $certificate = '/vol/lib/apache2/mercenaryinc/lvl6_qa/apns/apns-dev.pem';
	...
	* @access private
	*/
	private $sandboxCertificate = '/vol/lib/apache2/mercenaryinc/lvl6_qa/apns/apns-dev.pem'; // change this to your development certificate absolute path
...
/**
     ...
     * @access private
     */
	private function pushMessageNow($pid, $message, $token, $development){
