(function() {
  ...
  iOSCheckbox = (function() {
    ...
    iOSCheckbox.defaults = {
      ...
      onChange: function() {
		  var frmData = 'sound_settings='+$("#sound").is(':checked')+'&vibration_settings='+$("#vibration").is(':checked')+'&comment_settings='+$("#comment_notification").is(':checked')+'&notification_settings='+$("#other_notification").is(':checked')+'&splash_settings='+$("#splash").is(':checked');
